# search for min  number of paragraphs hand kinematics
import gc
import os.path
import pickle
import random
...
num_ch_1 = 1024
kernel_1 = 100
num_paragraphs_train = 4 # number of paragraphs in train set
hpc = 1
if hpc :
    RESULTS_PATH = "/CODE/AUTH_HAND_NUM_TRAIN/"
else:
    RESULTS_PATH = "AUTH_HAND_NUM_TRAIN/"
