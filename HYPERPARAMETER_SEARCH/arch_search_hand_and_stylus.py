# architecture search for hand and stylus kinematics
import gc
import os.path
import pickle
import random
...
for num_ch_1 in  [8, 16, 32, 64, 128, 256, 512, 1024]:
    for kernel_1 in [3, 5, 10, 25, 50, 75, 100, 250, 500, 650, 700, 750, 800]:
        MAIN_FILENAME ="AUTHENTICATION_ARCHITECTURE_HAND_AND_STYLUS/authen_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1)
