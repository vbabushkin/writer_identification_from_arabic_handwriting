# search for optimal window size EMG
import gc
import os.path
import pickle
import random
...
RESULTS_PATH = "/CODE/PARAM_SEARCH_AUTHENTICATION_WIN_EMG/"
MAIN_FILENAME =RESULTS_PATH+"emg_auth_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1)+"_w_"+str(winSize)+"_all"
...
#################################################################################################################
# load main data
with open('emg_clean50.pickle','rb') as handle:
...
for run in range(1,5):
    ...
    for winSize in [100, 500, 1000, 2000, 5000, 10000, 15000, 20000, 25000, 30000, 35000]:
        gc.enable()
