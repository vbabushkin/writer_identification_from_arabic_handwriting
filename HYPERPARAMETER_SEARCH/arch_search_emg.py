# architecture search for emg data
import gc
import os.path
import pickle
import random
...
winSize = 18000 # something in between np.arange(1000,37000,1000)
ovr = 0.9

for num_ch_1 in [32, 64, 128, 256, 384, 512, 576]:
    for kernel_1 in [ 5, 10, 25, 30, 35, 40, 45, 50, 100, 250, 500, 750]:
        MAIN_FILENAME ="AUTHENTICATION_ARCHITECTURE_EMG/authen_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1)
