#cv-evaluation of the performance of the model trained on EMG signals
import gc
import os.path
import pickle
import random
...
def create_model(X_train, y_train, kernel_1, num_ch_1, dropout, EPOCHS, BATCH_SIZE, lr, LOSS,
    ...
    dense_2 = Dense(576, activation='relu', name='dense_2')(flat_1)
...
ax.set_yticklabels(classNames, rotation=0, fontsize="20", va="center", ha="center")
