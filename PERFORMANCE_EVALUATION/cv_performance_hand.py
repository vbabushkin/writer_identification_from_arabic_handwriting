#cv-evaluation of the performance of the model trained on 110 hand kinematics features
import os.path
import gc
import pickle
import random
...
MAIN_FILENAME =RESULTS_PATH+"auth_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1)+"_w_"+str(winSize)+"_hand"
