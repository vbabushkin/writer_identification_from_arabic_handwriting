# cv-evaluation of the performance of the model trained on 7 stylus kinematics features
import gc
import os.path
import pickle
import random
...
MAIN_FILENAME =RESULTS_PATH+"auth_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1)+"_w_"+str(winSize)+"_stylus"
