# ablation experiments hand and stylus kinematics removing static features
import gc
import os
import os.path
import pickle
...
targets = ["z", "handWidth", "handArmLength", "handArmWidth"]
...
MAIN_FILENAME = RESULTS_PATH + "abl_auth_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1) + "_w_" + str(
    winSize) + "_hand_stylus_static_parallelized_200"
