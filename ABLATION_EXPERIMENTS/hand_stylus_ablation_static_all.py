# ablation experiments hand and stylus kinematics removing all static features
import gc
import os
import os.path
import pickle
...
MAIN_FILENAME = RESULTS_PATH + "abl_auth_ch1_" + str(num_ch_1) + "_k1_" + str(kernel_1) + "_w_" + str(
    winSize) + "_hand_stylus_static_all_parallelized_200"
...
indices = {feat: features_117.index(feat) for feat in targets if feat in features_117}
print(indices)
target_indices = [features_117.index(feat) for feat in targets]
